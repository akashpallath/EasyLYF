...
import com.example.easylyf.FilterOrderShop;
import com.example.easylyf.R;
import com.example.easylyf.activites.OrderDetailsSellerActivity;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public int getItemCount() {
        return orderShopArrayList.size(); //return size of lists/number of records
    }
    ...
    class  HolderOrderShop extends RecyclerView.ViewHolder{
        ...
        //ui views for row_order_seller.xml
