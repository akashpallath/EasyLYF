...
public class AdapterCartItem extends RecyclerView.Adapter<AdapterCartItem.HolderCartItem>{
    ...
    public void onBindViewHolder(@NonNull HolderCartItem holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemPricev.setText(""+cost);
        ...
        holder.itemRemoveTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //will create table if note exists, but in that case will must exist
                ...
                Toast.makeText(context, "Removed from car.....", Toast.LENGTH_SHORT).show();
    ...
    class HolderCartItem extends RecyclerView.ViewHolder{
        ...
        //uid view of row_cart.xml
        private TextView itemTitleTv, itemPricev, itemPriceEachTv, itemQuantityTv, itemRemoveTv;
        ...
        public HolderCartItem(@NonNull View itemView) {
            ...
            itemPricev = itemView.findViewById(R.id.itemPricev);
